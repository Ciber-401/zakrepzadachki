# Задание 9:
#Фильтрация с помощью filter(). Необходимо написать программу, и передать ее filter(),
...
#Данные, которые будут переданы в filter() должны возвращать True, если в слове есть буква ‘p’
text = ["""
